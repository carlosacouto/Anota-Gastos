...
class Bd{
	...
	gravar(d){
		...
		//transformamos um objeto criado dentro da aplicação em um arquivo JSON
		//Objetos só podem ser utilizados dentro da aplicação, o Json é para usarmos esses valores por fora, no localstorage no caso
...
function carregaListaDespesas(despesas = Array(), filtro = false){
	...
	//Percorrer o array despesas, listando cada um de forma dinâmica
